...
import MotionTreeNode from './MotionTreeNode.tsx';
import { findExpandedKeys, getExpandRange } from './utils/diffUtil.ts';
import { getTreeNodeProps, getKey } from './utils/treeUtil.ts';
...
const RefNodeList: React.Compat.ForwardFn<NodeListProps,NodeListRef> = (props, ref) => {
  const {
    prefixCls,
    data,
    selectable,
  ...
  const [motionType, setMotionType] = React.useState<'show' | 'hide' | undefined>(undefined);
        ...
        {(treeNode: FlattenNode) => {
          ...
          return (
            ...
            <MotionTreeNode
              ...
              isEnd={isEnd}
              motion={motion}
              motionNodes={key === MOTION_KEY ? transitionRange : undefined}
...
const NodeList = React.Compat.forwardRef(RefNodeList);
