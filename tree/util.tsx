...
import { TreeProps, AllowDrop } from './Tree.tsx';
...
export function getDragChildrenKeys<TreeDataType extends BasicDataNode = DataNode>(
  ...
  const dragChildrenKeys:Array<any> = [];
...
const internalProcessProps = (props: DataNode): Partial<TreeNodeProps> => props as Partial<TreeNodeProps>;
