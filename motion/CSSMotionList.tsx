...
import OriginCSSMotion from './CSSMotion.tsx';
...
import type { KeyObject } from './util/diff.ts';
...
export interface CSSMotionListProps
  extends Omit<CSSMotionProps, 'onVisibleChanged'>,
    Omit<React.JSX.HTMLAttributes<any>, 'children'> {
          ...
          {keyEntities.map(({ status, ...eventProps }) => {
            ...
            return (
              <CSSMotion
                ...
                onVisibleChanged={(changedVisible:any) => {
